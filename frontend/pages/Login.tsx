...
import { Music2, Github, Mail, ArrowRight, Loader2, Lock, User, AlertCircle } from 'lucide-react';
...
export default function Login() {
  const { loginWithProvider, loginWithEmail, registerWithEmail, isLoading } = useAuthStore();
        ...
        >
          <div className="text-center mb-8">
             ...
             <h1 className="text-3xl font-bold text-white mb-2">
                {mode === 'login' ? 'Welcome Back' : 'Join SonicStream'}
             </h1>
          ...
          <div className="space-y-4">
            ...
            <div className="relative py-4">
               ...
               <div className="relative flex justify-center text-sm">
                 <span className="px-2 bg-black/60 text-gray-500">Or continue with email</span>
               </div>
            </div>
            ...
            <form onSubmit={handleEmailSubmit} className="space-y-4">
               ...
               >
                  {isLoading ? <Loader2 className="animate-spin" /> : <>{mode === 'login' ? 'Sign In' : 'Create Account'} <ArrowRight size={18} /></>}
               </button>
            </form>
            ...
            <div className="text-center pt-2">
                <button 
                    ...
                    className="text-sonic-accent hover:text-sonic-accentHover text-sm font-medium transition-colors"
                >
