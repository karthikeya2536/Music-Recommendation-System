...
const FLIP_WORDS = ["Sonicstream", "High Fidelity", "The Future", "Immersion"];
...
export const HeroParallax = ({
  ...
  return (
    <div
      ref={ref}
      className="h-[120vh] md:h-[160vh] py-0 pb-10 overflow-hidden antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d]"
    >
      <Header />
      <motion.div
        style={{
...
export const ProductCard = ({
  ...
  return (
    <div 
      ...
      className="group/product h-48 w-[14rem] md:h-80 md:w-[24rem] relative flex-shrink-0 rounded-xl overflow-hidden cursor-pointer mr-8 block bg-sonic-800 z-30"
    >
      <img
        ...
        className="object-cover object-left-top absolute h-full w-full inset-0 brightness-[0.7] group-hover/product:brightness-100 transition-all duration-500"
        alt={product.title}
      />
      <div className="absolute inset-0 bg-black/40 opacity-0 group-hover/product:opacity-100 transition-opacity duration-300 flex items-center justify-center z-10">
         <div
